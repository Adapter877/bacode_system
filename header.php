...
// ตั้ง title ตามไฟล์ปัจจุบัน (ตามโค้ดเดิม)
...
<html lang="th">
  <head>
    ...
    <style>
      /* --- Fix Alignment + Equal Heights on Navbar --- */
      ...
      .background-header .navbar-brand h2{
        margin:0; line-height:1; font-size:24px; /* ลดฟอนต์แบรนด์นิดให้เท่ากับแถบนำทาง */
      }
      /* link แต่ละตัวให้สูงเท่ากันและกึ่งกลางแนวตั้ง */
      .navbar-nav .nav-item { display:flex; align-items:center; }
      .navbar-nav .nav-link{
        display:flex; align-items:center;
        height:48px;             /* ความสูงคงที่ของลิงก์ */
        padding:0 14px;          /* ช่องไฟซ้ายขวา */
        line-height:1;           /* กันเด้ง */
      }

      /* Avatar ให้พอดีกับความสูงลิงก์ */
      .profile-avatar{
        width:32px; height:32px; border-radius:50%;
        display:inline-flex; align-items:center; justify-content:center;
        font-weight:700; font-size:.9rem; background:#111827; color:#fff;
        border:2px solid rgba(0,0,0,.08);
      }

      /* Dropdown โปรไฟล์ให้กว้างเท่ากัน และจัด layout */
      ...
      .profile-grid{
        ...
        row-gap:.35rem; column-gap:.5rem; font-size:.92rem;
      }
      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="about.php">
            <h2>ระบบค้นหารหัสกิจกรรมนักศึกษา<em>.</em></h2>
          </a>
...
?>
              ...
              <li class="nav-item <?php echo $active_blog; ?>">
...
<?php else: ?>
<?php $isAdmin = (intval($role) === 0 || intval($role) === 1); ?>
<?php if ($isAdmin): ?>
              <li class="nav-item">
...
<?php endif; ?>
    ...
    <!-- JS ของธีมเดิม (ให้ dropdown ทำงาน) -->
